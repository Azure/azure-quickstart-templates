...
This template deploys a **Standalone Tableau Server instance on a Virtual Machine running Ubuntu or RHEL** in its own Virtual Network.
...
+ <a href=https://docs.microsoft.com/en-us/azure/virtual-machines/linux/overview>**Virtual Machine**</a>: Standard D16 v3 (16 vCPUs, 64 GB mem) or a memory or compute optimized 16 vCPU instance running Ubuntu 16.04.0-LTS or RHEL 7.8 with 2 attached disks (30, 64 GiB SSD) with Tableau Server installed
