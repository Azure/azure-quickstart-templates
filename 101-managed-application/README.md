...
To learn about how to add metrics and alerts to your application please visit:
+ [Creating managed application with metrics and alerts](https://github.com/Olgaian/azure-quickstart-templates/tree/101amawithmetrics/101-managed-application-with-metrics-and-alerts)