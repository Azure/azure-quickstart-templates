...
@description('Specifies the object ID of a service principal in the Azure Active Directory tenant for the vault. The object ID must be unique for the list of access policies. Get it by using Get-AzADServicePrincipal cmdlets.')
param spId string

@description('Name of Azure Key Vault')
param akvAccountName string
