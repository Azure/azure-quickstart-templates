...
| resourceApplicationId  | Azure AD application Id which will be used by entitlement management as a resource in token and will be added to logic auth settings to verify this as auidence.  |
