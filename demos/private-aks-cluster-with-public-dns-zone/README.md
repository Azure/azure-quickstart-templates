...
This project can be used to deploy a [private AKS cluster with a Public DNS address](https://learn.microsoft.com/azure/aks/private-clusters#create-a-private-aks-cluster-with-a-public-dns-address) with [Dynamic allocation of IPs and enhanced subnet support](https://learn.microsoft.com/azure/aks/configure-azure-cni#dynamic-allocation-of-ips-and-enhanced-subnet-support-preview), [Azure Active Directory Pod Identity](https://learn.microsoft.com/azure/aks/use-azure-ad-pod-identity), and more.
...
- [PodSecurityPolicyPreview](https://learn.microsoft.com/azure/aks/use-pod-security-policies)
- [RunCommandPreview](https://learn.microsoft.com/azure/aks/private-clusters#options-for-connecting-to-the-private-cluster)
- [EnablePodIdentityPreview](https://learn.microsoft.com/azure/aks/use-azure-ad-pod-identity)
- [EnablePrivateClusterPublicFQDN](https://learn.microsoft.com/azure/aks/private-clusters#create-a-private-aks-cluster-with-a-public-dns-address)
- [PodSubnetPreview"](https://learn.microsoft.com/azure/aks/configure-azure-cni#dynamic-allocation-of-ips-and-enhanced-subnet-support-preview)
- [AutoUpgradePreview](https://learn.microsoft.com/azure/aks/upgrade-cluster#set-auto-upgrade-channel)
