...
This template deploys an Azure Monitor alert which notifies you in an event **the total backend response 5xx status is greater than the [dynamic threshold](https://learn.microsoft.com/azure/azure-monitor/alerts/alerts-dynamic-thresholds)**.
