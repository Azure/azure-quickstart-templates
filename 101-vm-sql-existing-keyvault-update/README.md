# This template will configure the Azure Key Vault Integration feature on  setup Azure Key Vault on any existing Azure Virtual machine with SQL Server Enterprise edition.
