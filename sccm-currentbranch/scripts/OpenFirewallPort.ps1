...
if($rolelist -contains "Site Server")
{
    ...
    New-NetFirewallRule -DisplayName 'SQL over TCP  Inbound' -Profile Any -Direction Inbound -Action Allow -Protocol TCP -LocalPort 1433 -Group "For SCCM"
    New-NetFirewallRule -DisplayName 'SQL over TCP  Outbound' -Profile Any -Direction Outbound -Action Allow -Protocol TCP -LocalPort 1433 -Group "For SCCM"
...
if($rolelist -contains "PXE Service Point")
{
    ...
    New-NetFirewallRule -DisplayName 'SQL over TCP  Outbound' -Profile Any -Direction Outbound -Action Allow -Protocol TCP -LocalPort 1433 -Group "For SCCM PXE SP"
...
{
    New-NetFirewallRule -DisplayName 'SQL over TCP  Inbound' -Profile Any -Direction Inbound -Action Allow -Protocol TCP -LocalPort 1433 -Group "For SCCM RSP"
    New-NetFirewallRule -DisplayName 'SQL over TCP  Outbound' -Profile Any -Direction Outbound -Action Allow -Protocol TCP -LocalPort 1433 -Group "For SCCM RSP"
...
if($rolelist -contains "Management Point")
{
    ...
    New-NetFirewallRule -DisplayName 'SQL over TCP  Outbound' -Profile Any -Direction Outbound -Action Allow -Protocol TCP -LocalPort 1433 -Group "For SCCM MP"
...
if($rolelist -contains "Server Locator Point")
{
    ...
    New-NetFirewallRule -DisplayName 'SQL over TCP  Outbound' -Profile Any -Direction Outbound -Action Allow -Protocol TCP -LocalPort 1433 -Group "For SQL Server SLP"
...
{
    New-NetFirewallRule -DisplayName 'SQL over TCP  Inbound' -Profile Any -Direction Inbound -Action Allow -Protocol TCP -LocalPort 1433 -Group "For SQL Server"
    New-NetFirewallRule -DisplayName 'WMI' -Program "%systemroot%\system32\svchost.exe" -Service "winmgmt" -Profile Any -Direction Inbound -Action Allow -Protocol TCP -LocalPort any -Group "For SQL Server WMI"
