...
urlFragment: data-factory-v2-blob-to-mysql-copy
languages:
- json
---
...
* Azure Database for MySQL. You use the database as a sink data store. If you don't have a MySQL database, see [Create a MySQL database](https://learn.microsoft.com/azure/mysql/quickstart-create-server-database-portal) for steps to create one.
