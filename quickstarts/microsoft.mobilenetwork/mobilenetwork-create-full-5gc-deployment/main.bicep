...
@description('The virtual network name on port 5 on your Azure Stack Edge Pro device corresponding to the user plane interface on the access network. For 5G, this interface is the N3 interface, whereas for 4G, it\'s the S1-U interface.')
param userPlaneAccessInterfaceName string = ''

@description('The virtual network name on port 6 on your Azure Stack Edge Pro device corresponding to the user plane interface on the data network. For 5G, this interface is the N6 interface, whereas for 4G, it\'s the SGi interface.')
