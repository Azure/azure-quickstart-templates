...
resource existingMobileNetwork 'Microsoft.MobileNetwork/mobileNetworks@2023-06-01' existing = {
  name: existingMobileNetworkName

  #disable-next-line BCP081
  resource existingDataNetwork 'dataNetworks@2023-06-01' existing = {
    name: existingDataNetworkName
  }

  #disable-next-line BCP081
  resource existingSlice 'slices@2023-06-01' existing = {
    name: existingSliceName
  }

  #disable-next-line BCP081
  resource exampleService 'services@2023-06-01' = {
    name: serviceName
    location: location
    properties: {
  ...
  #disable-next-line BCP081
  resource exampleSimPolicy 'simPolicies@2023-06-01' = {
    name: simPolicyName
    location: location
    properties: {
      ueAmbr: {
