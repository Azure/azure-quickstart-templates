...
To deploy your our ASP.NET app you can follow that [tutorial](https://learn.microsoft.com/azure/app-service/app-service-web-get-started-dotnet#create-an-aspnet-core-web-app).
