...
This template is to be used with: [Quickstart: Create App Service app using an ARM template](https://learn.microsoft.com/azure/app-service/quickstart-arm-template).
