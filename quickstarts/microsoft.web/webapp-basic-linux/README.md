...
urlFragment: webapp-basic-linux
languages:
- json
- bicep
---
...
![Bicep Version](https://azurequickstartsservice.blob.core.windows.net/badges/quickstarts/microsoft.web/webapp-basic-linux/BicepVersion.svg)
