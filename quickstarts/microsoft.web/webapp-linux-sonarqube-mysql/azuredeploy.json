{
    ...
    "variables": {
        ...
        "firewallrule": "[concat(variables('serverName'),'firewall')]"
    },
    "resources": [
        {
        ...
        },
        {
            ...
            "resources": [
                ...
                },
                {
                    ...
                    "dependsOn": [
                        "[resourceId('Microsoft.DBforMySQL/servers', variables('serverName'))]",
                        "[resourceId('Microsoft.DBforMySQL/servers/firewallRules', variables('serverName'), variables('firewallrule'))]"
                    ],
                    "properties": {
                        "charset": "utf8",
