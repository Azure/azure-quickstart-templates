...
With a **Function App** you also deploy a Web Hosting Plan. The Web Plan is charged by Consumption. For more information about Hosting Plans click [here!](https://learn.microsoft.com/azure/azure-functions/functions-scale)

If you are new to Function Apps, see:

- [Azure Functions](https://azure.microsoft.com/services/functions/).
- [Azure Function Documentation](https://learn.microsoft.com/azure/azure-functions/)
