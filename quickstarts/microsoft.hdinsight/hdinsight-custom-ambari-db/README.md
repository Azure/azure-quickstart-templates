---
description: This template allows you to create an HDInsight cluster in an existing virtual network with a new SQL DB that serves as both a custom Ambari DB and Hive Metastore. You must have an existing SQL Sever, storage account, and VNET.
page_type: sample
products:
- azure
- azure-resource-manager
urlFragment: hdinsight-custom-ambari-db
languages:
- json
---
...
`Tags: Microsoft.Resources/deployments, Microsoft.Sql/servers/databases, Microsoft.HDInsight/clusters, Microsoft.Storage/storageAccounts, Microsoft.Network/virtualNetworks, Microsoft.Sql/servers, firewallrules, databases`
