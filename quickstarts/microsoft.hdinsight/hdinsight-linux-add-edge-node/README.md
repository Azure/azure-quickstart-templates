...
For more information about creating and using edge node, see "https://learn.microsoft.com/azure/hdinsight/hdinsight-apps-use-edge-node" Use empty edge nodes in HDInsight.
