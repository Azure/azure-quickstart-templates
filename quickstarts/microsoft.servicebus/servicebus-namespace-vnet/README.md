...
For information about using this template, see [Create a Service Bus Virtual Network rule for a Namespace](https://learn.microsoft.com/azure/service-bus-messaging/service-bus-service-endpoints)
