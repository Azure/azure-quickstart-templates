...
For information about using this template, see [Create a Service Bus IP Filter rule for a Namespace](https://docs.microsoft.com/azure/service-bus-messaging/service-bus-ip-filtering)
