---
description: This template enables you to deploy a Service Bus Standard namespace, and authorization rules for both the namespace and a queue.
page_type: sample
products:
- azure
- azure-resource-manager
urlFragment: servicebus-create-authrule-namespace-and-queue
languages:
- json
---
...
`Tags: Microsoft.ServiceBus/namespaces, Queues, AuthorizationRules, Microsoft.ServiceBus/namespaces/authorizationRules`
