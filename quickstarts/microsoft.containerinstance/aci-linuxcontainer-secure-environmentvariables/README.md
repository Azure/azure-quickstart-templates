---
description: Deploy a Linux container that has a secure environment variable using Azure Container Instances.
page_type: sample
products:
- azure
- azure-resource-manager
urlFragment: aci-linuxcontainer-secure-environmentvariables
languages:
- json
---
...
This template demonstrates a simple use case for secure environment variables of [Azure Container Instances](https://learn.microsoft.com/azure/container-instances/).
