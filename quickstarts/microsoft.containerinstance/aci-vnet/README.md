...
This template demonstrates a simple use case for deploying a container instance into an Azure virtual network. (https://learn.microsoft.com/azure/container-instances/container-instances-vnet).
