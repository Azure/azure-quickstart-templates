...
![Bicep Version](https://azurequickstartsservice.blob.core.windows.net/badges/quickstarts/microsoft.recoveryservices/recovery-services-backup-vms/BicepVersion.svg)
...
For more information, Visit [Back up Resource Manager VMs to a Recovery Services vault] https://learn.microsoft.com/azure/backup/backup-azure-vms-first-look-arm)
