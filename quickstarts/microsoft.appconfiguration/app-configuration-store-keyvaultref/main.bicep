...
param keyValueName string = 'KeyVaultReferenceSample'
...
resource configStoreNamekeyValueName 'Microsoft.AppConfiguration/configurationStores/keyValues@2020-07-01-preview' = {
  parent: configStore
  name: keyValueName
  properties: {
