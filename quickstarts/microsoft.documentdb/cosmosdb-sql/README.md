...
![Bicep Version](https://azurequickstartsservice.blob.core.windows.net/badges/quickstarts/microsoft.documentdb/cosmosdb-sql/BicepVersion.svg)
...
This template will create an Azure Cosmos DB account for Core (SQL) API, in two regions, a database and container with dedicated throughput showing multiple indexing and policy options. To learn more about how to deploy the template, see the [quickstart](https://learn.microsoft.com/azure/cosmos-db/quick-create-template) article.
