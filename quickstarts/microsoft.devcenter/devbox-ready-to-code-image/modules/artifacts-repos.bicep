...
var reposWithDefaults = [
  for repo in repos: {
    ...
    DesktopShortcutHost: repo.?DesktopShortcutHost ?? ''
...
var terminalShortcutRepos = filter(reposWithDefaults, repo => repo.DesktopShortcutHost == 'Terminal')
...
output anyTerminalShortcutRepos bool = (length(terminalShortcutRepos) > 0)
