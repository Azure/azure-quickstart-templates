...
param configureWindowsTerminal bool
...
var optionalInstallWindowsTerminal = configureWindowsTerminal
  ? [
      {
        name: 'windows-install-terminal'
      }
    ]
  : []
...
var configureWindowsTerminalUserTask = configureWindowsTerminal
  ? [
      {
        Task: 'configure-terminal-installation'
      }
    ]
  : []
...
var firstLogonTasks = concat(
  ...
  configureWindowsTerminalUserTask,
...
output artifacts object = {
  ...
  optionalInstallWindowsTerminal: optionalInstallWindowsTerminal
