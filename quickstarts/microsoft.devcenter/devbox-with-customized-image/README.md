...
This template would create all Dev Box admin resources as per Dev Box quick start guide (https://learn.microsoft.com/en-us/azure/dev-box/quickstart-create-dev-box). You can view all resources created, or directly go to https://devportal.microsoft.com to create your first Dev Box.
