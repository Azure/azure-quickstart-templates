...
Describe "run-artifact.Tests" {
    ...
    It "Success" {
        ____Invoke-ImageFactory-Artifact -____ImageFactoryArtifactName "run-artifact-test" -____ImageFactoryParamsBase64 $script:defaultParams
    ...
    It "SuccessWithComplexString" {
        ...
        ____Invoke-ImageFactory-Artifact -____ImageFactoryArtifactName "run-artifact-test" -____ImageFactoryParamsBase64 $inputParams
        Should -Invoke ____ExitOne -Times 0 -Exactly
        $global:TestResults | Should -Not -BeNullOrEmpty
    ...
    It "SuccessWithEmptyParams" {
        ____Invoke-ImageFactory-Artifact -____ImageFactoryArtifactName "run-artifact-test"
        Should -Invoke ____ExitOne -Times 0 -Exactly
        $global:TestResults | Should -Not -BeNullOrEmpty
