...
param aksClusterKubernetesVersion string = '1.28.5'
...
resource vmName_GuestAttestation 'Microsoft.Compute/virtualMachines/extensions@2023-09-01' = if ((securityType == 'TrustedLaunch') && ((securityProfileJson.uefiSettings.secureBootEnabled == true) && (securityProfileJson.uefiSettings.vTpmEnabled == true))) {
  parent: vm
...
resource vmName_AzureMonitorLinuxAgent 'Microsoft.Compute/virtualMachines/extensions@2023-09-01' = {
  parent: vm
...
resource applicationGatewayUserDefinedManagedIdentity 'Microsoft.ManagedIdentity/userAssignedIdentities@2023-07-31-preview' = {
...
resource aksContributorRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: aksClusterUserDefinedManagedIdentity
...
resource kvRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: keyVault
  name: guid('${resourceGroup().id}${readerRoleId}')
  properties: {
...
resource acrVNetLink 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2020-06-01' = if (acrSku == 'Premium') {
...
resource acrPrivateEndpoint 'Microsoft.Network/privateEndpoints@2023-09-01' = if (acrSku == 'Premium') {
...
resource acrPrivateDnsZoneGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2023-09-01' = if (acrSku == 'Premium') {
