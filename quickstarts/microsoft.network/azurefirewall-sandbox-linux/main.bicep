...
resource azfwRouteTable 'Microsoft.Network/routeTables@2023-05-01' = {
...
resource jumpBoxPublicIPAddress 'Microsoft.Network/publicIPAddresses@2023-05-01' = {
...
resource jumpBoxNsg 'Microsoft.Network/networkSecurityGroups@2023-05-01' = {
  name: jumpBoxNsgName
  location: location
  properties: {
    securityRules: [
...
resource jumpBoxExtension 'Microsoft.Compute/virtualMachines/extensions@2023-07-01' = if ((securityType == 'TrustedLaunch') && ((securityProfileJson.uefiSettings.secureBootEnabled == true) && (securityProfileJson.uefiSettings.vTpmEnabled == true))) {
  parent: jumpBox
  name: extensionName
  location: location
  properties: {
...
resource server 'Microsoft.Compute/virtualMachines@2023-07-01' = {
  name: 'Server'
  location: location
  properties: {
    hardwareProfile: {
...
resource serverExtension 'Microsoft.Compute/virtualMachines/extensions@2023-07-01' = if (vTPM && secureBoot) {
  parent: server
  name: extensionName
  location: location
  properties: {
