...
**Note:** Branches that are connected to Azure Virtual WAN using ExpressRoute require the ExpressRoute Global Reach feature to communicate with each other. This means the hubs must be deployed in a Global Reach supported [region](https://docs.microsoft.com/en-us/azure/expressroute/expressroute-global-reach#availability).
