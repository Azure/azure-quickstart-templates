---
description: This template creates an Azure Firewall sandbox (Linux) with one firewall force tunneled through another firewall in a peered VNET
page_type: sample
products:
- azure
- azure-resource-manager
urlFragment: azurefirewall-forced-tunneling
languages:
- json
---
...
Azure Firewall is currently a managed public preview that you need to explicitly enable using the Register-AzureRmProviderFeature PowerShell command. Learn more at https://learn.microsoft.com/azure/firewall.
