...
urlFragment: eventhub-namespace-vnet
languages:
- json
---
...
For information about using this template, see [Create a Event Hubs Virtual Network rule for a Namespace](https://learn.microsoft.com/azure/event-hubs/event-hubs-service-endpoints)
