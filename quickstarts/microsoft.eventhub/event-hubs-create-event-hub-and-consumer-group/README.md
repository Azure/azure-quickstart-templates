...
urlFragment: event-hubs-create-event-hub-and-consumer-group
languages:
- bicep
- json
---
...
![Bicep Version](https://azurequickstartsservice.blob.core.windows.net/badges/quickstarts/microsoft.eventhub/event-hubs-create-event-hub-and-consumer-group/BicepVersion.svg)
