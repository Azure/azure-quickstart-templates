...
For information about using this template, see [Create a Event Hubs IP Filter rule for a Namespace](https://learn.microsoft.com/azure/event-hubs/event-hubs-ip-filtering)
