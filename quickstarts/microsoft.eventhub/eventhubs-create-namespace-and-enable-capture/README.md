...
urlFragment: eventhubs-create-namespace-and-enable-capture
languages:
- json
---
...
For information about using this template, see [Create an Event Hubs namespace with Event Hub and enable Capture using an ARM template](https://learn.microsoft.com/azure/event-hubs/event-hubs-resource-manager-namespace-event-hub-enable-capture)
...
`Tags: Microsoft.EventHub/Namespaces, eventhubs, Microsoft.Storage/storageAccounts`
