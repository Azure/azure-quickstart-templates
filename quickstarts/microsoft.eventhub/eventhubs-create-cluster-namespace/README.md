---
description: This template enables you to create EventHubs Cluster and a namespace in cluster
page_type: sample
products:
- azure
- azure-resource-manager
urlFragment: eventhubs-create-cluster-namespace
languages:
- json
- bicep
---
...
![Bicep Version](https://azurequickstartsservice.blob.core.windows.net/badges/quickstarts/microsoft.eventhub/eventhubs-create-cluster-namespace/BicepVersion.svg)
...
`Tags: Microsoft.EventHub/clusters, Microsoft.EventHub/namespaces`
