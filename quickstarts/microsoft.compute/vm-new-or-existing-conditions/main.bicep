...
resource storageAccount 'Microsoft.Storage/storageAccounts@2020-08-01-preview' = if (storageNewOrExisting == 'new') {
...
resource networkSecurityGroup 'Microsoft.Network/networkSecurityGroups@2019-08-01' = if (virtualNetworkNewOrExisting == 'new') {
...
resource virtualNetwork 'Microsoft.Network/virtualNetworks@2017-09-01' = if (virtualNetworkNewOrExisting == 'new') {
