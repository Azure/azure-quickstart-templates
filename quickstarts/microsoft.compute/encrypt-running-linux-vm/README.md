---
description: This template enables encryption on a running linux vm using Microsoft Entra client secret.
page_type: sample
products:
- azure
...
This template enables encryption on a running linux vm using Microsoft Entra ID client secret. This template assumes that the VM is located in the same region as the resource group. If not, please edit the template to pass appropriate location for the VM sub-resources.
