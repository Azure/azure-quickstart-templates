...
param _artifactsLocation string = 'https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/quickstarts/microsoft.compute/vmss-azure-files-linux/'
              ...
              ipConfigurations: [
                {
                  ...
                  properties: {
                    ...
                    loadBalancerInboundNatPools: [
                      ...
                      {
                        id: resourceId('Microsoft.Network/loadBalancers/inboundNatPools', loadBalancerName, 'natpool2')
                      }
                    ]
                  }
                }
        ...
        extensions: [
          {
            ...
            properties: {
              ...
              settings: {
                fileUris: [
                  uri(_artifactsLocation, 'mountazurefiles.sh${_artifactsLocationSasToken}')
                ]
              }
              protectedSettings: {
