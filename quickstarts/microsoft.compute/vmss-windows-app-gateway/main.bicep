...
resource appGwPublicIPAddress 'Microsoft.Network/publicIPAddresses@2021-02-01' = {
...
resource namingInfixVal 'Microsoft.Compute/virtualMachineScaleSets@2022-11-01' = {
  name: namingInfix
  location: location
  sku: {
    name: vmSku
