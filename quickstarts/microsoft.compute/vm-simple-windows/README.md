...
This template allows you to deploy a simple [Azure Generation 2](https://docs.microsoft.com/azure/virtual-machines/generation-2) Windows VM using a few different options for the Windows version, using the latest patched version. This will deploy a D2s_v3 size VM in the resource group location and return the fully qualified domain name of the VM.
