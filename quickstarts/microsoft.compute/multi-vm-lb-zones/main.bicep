...
resource nic 'Microsoft.Network/networkInterfaces@2023-05-01' = [for i in range(0, numberOfVms): {
  name: '${nicName}${i}'
  location: location
  properties: {
    ipConfigurations: [
...
resource loadBalancerFrontend 'Microsoft.Network/loadBalancers/frontendIPConfigurations@2023-05-01' existing = {
  parent: lb
  name: 'loadBalancerFrontend'
}

resource inboundNatRule 'Microsoft.Network/loadBalancers/inboundNatRules@2023-05-01' = [for i in range(0, numberOfVms): {
  parent: lb
...
resource dns 'Microsoft.Compute/virtualMachines@2023-07-01' = [for i in range(0, numberOfVms): {
  name: '${dnsName}${i}'
...
resource guestAttestation 'Microsoft.Compute/virtualMachines/extensions@2023-07-01' = [for i in range(0, numberOfVms): if ((securityType == 'TrustedLaunch') && ((securityProfileJson.uefiSettings.secureBootEnabled == true) && (securityProfileJson.uefiSettings.vTpmEnabled == true))) {
  parent: dns[i]
