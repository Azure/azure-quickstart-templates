...
urlFragment: confidential-vm-windows-keyvault-secure-key-release
languages:
- json
- bicep
---
# Deploy a Windows CVM, configured for Secure Key Release

![Azure Public Test Date](https://azurequickstartsservice.blob.core.windows.net/badges/quickstarts/microsoft.compute/confidential-vm-windows-keyvault-secure-key-release/PublicLastTestDate.svg)
![Azure Public Test Result](https://azurequickstartsservice.blob.core.windows.net/badges/quickstarts/microsoft.compute/confidential-vm-windows-keyvault-secure-key-release/PublicDeployment.svg)

![Azure US Gov Last Test Date](https://azurequickstartsservice.blob.core.windows.net/badges/quickstarts/microsoft.compute/confidential-vm-windows-keyvault-secure-key-release/FairfaxLastTestDate.svg)
![Azure US Gov Last Test Result](https://azurequickstartsservice.blob.core.windows.net/badges/quickstarts/microsoft.compute/confidential-vm-windows-keyvault-secure-key-release/FairfaxDeployment.svg)

![Best Practice Check](https://azurequickstartsservice.blob.core.windows.net/badges/quickstarts/microsoft.compute/confidential-vm-windows-keyvault-secure-key-release/BestPracticeResult.svg)
![Cred Scan Check](https://azurequickstartsservice.blob.core.windows.net/badges/quickstarts/microsoft.compute/confidential-vm-windows-keyvault-secure-key-release/CredScanResult.svg)

![Bicep Version](https://azurequickstartsservice.blob.core.windows.net/badges/quickstarts/microsoft.compute/confidential-vm-windows-keyvault-secure-key-release/BicepVersion.svg)

[![Deploy To Azure](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/1-CONTRIBUTION-GUIDE/images/deploytoazure.svg?sanitize=true)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2Fquickstarts%2Fmicrosoft.compute%2Fconfidential-vm-windows-keyvault-secure-key-release%2Fazuredeploy.json)
[![Deploy To Azure US Gov](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/1-CONTRIBUTION-GUIDE/images/deploytoazuregov.svg?sanitize=true)](https://portal.azure.us/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2Fquickstarts%2Fmicrosoft.compute%2Fconfidential-vm-windows-keyvault-secure-key-release%2Fazuredeploy.json)
[![Visualize](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/1-CONTRIBUTION-GUIDE/images/visualizebutton.svg?sanitize=true)](http://armviz.io/#/?load=https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2Fquickstarts%2Fmicrosoft.compute%2Fconfidential-vm-windows-keyvault-secure-key-release%2Fazuredeploy.json)

## Deploy a confidential Windows virtual machine that can perform the Secure Key Release operation on an Azure Key Vault Premium, HSM-backed, key
...
1. Deploys a confidential Windows virtual machine.
    ...
    * Installs the Microsoft C and C++ ([MSVC](https://docs.microsoft.com/en-US/cpp/windows/latest-supported-vc-redist?view=msvc-170)) runtime libraries.
...
> The `AttestationClientApp` binary can be found in `C:\confidential-computing-cvm-guest-attestation-main\cvm-platform-checker-exe\Windows\cvm_windows_attestation_client.zip`, by unzipping the file.
