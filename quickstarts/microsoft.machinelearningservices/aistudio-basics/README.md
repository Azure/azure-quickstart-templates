...
Azure AI Studio is built on Azure Machine Learning as the primary resource provider and takes a hard dependency on the Cognitive Services resource provider to surface model-as-a-service endpoints.
