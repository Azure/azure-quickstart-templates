...
This sample template demonstrates how to create a Scheduled Analytics Rule in your Microsoft Sentinel workspace. For more information about analytics rules, visit [Create custom analytics rules to detect threats](https://learn.microsoft.com/azure/sentinel/detect-threats-custom)
