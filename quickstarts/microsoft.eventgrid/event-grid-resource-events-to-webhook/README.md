---
description: Creates Event Grid subscription to either resource group or Azure subscription.
page_type: sample
products:
- azure
- azure-resource-manager
urlFragment: event-grid-resource-events-to-webhook
languages:
- json
---
