...
This template creates a new Azure Cognitive Search Service with a private endpoint. The [quickstart](https://docs.microsoft.com/azure/search/search-get-started-arm) article describes how to deploy the template.
