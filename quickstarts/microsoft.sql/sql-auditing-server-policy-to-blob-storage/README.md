---
description: This template allows you to deploy an Azure SQL server with Auditing enabled to write audit logs to a blob storage
page_type: sample
products:
- azure
- azure-resource-manager
urlFragment: sql-auditing-server-policy-to-blob-storage
languages:
- json
- bicep
---
...
![Bicep Version](https://azurequickstartsservice.blob.core.windows.net/badges/quickstarts/microsoft.sql/sql-auditing-server-policy-to-blob-storage/BicepVersion.svg)
