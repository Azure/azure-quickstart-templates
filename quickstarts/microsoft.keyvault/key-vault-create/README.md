...
This template creates an Azure Key Vault and a secret stored inside the key vault. To learn more about how to deploy the template, see the [quickstart](https://learn.microsoft.com/azure/key-vault/secrets/quick-create-template) article.
...
`Tags: Azure Key Vault, Key Vault, Secrets, Resource Manager, Resource Manager templates, ARM templates, Microsoft.KeyVault/vaults, Microsoft.KeyVault/vaults/secrets`
