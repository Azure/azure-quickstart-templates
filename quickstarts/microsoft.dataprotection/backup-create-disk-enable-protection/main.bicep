...
resource vaultName_backupPolicyName 'Microsoft.DataProtection/backupVaults/backupPolicies@2020-01-01-alpha' = {
...
resource roleNameGuidForDisk 'Microsoft.Authorization/roleAssignments@2020-04-01-preview' = {
  ...
  properties: {
    ...
    principalId: reference(vaultName_resource.id, '2020-01-01-alpha', 'Full').identity.principalId
  }
  dependsOn: [
...
resource vaultName_diskName 'Microsoft.DataProtection/backupvaults/backupInstances@2020-01-01-alpha' = {
  parent: vaultName_resource
  name: '${diskName}'
  properties: {
