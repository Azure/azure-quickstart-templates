---
description: This template creates an ADLess Azure Local 24H2 cluster (Local Identity with Azure Key Vault) with SAN Storage using an ARM template..
page_type: sample
products:
- azure
...
- json
---
# creates an Azure Local 24H2 cluster (Local Identity with Azure Key Vault) with external SAN Storage
