---
description: This template creates an Azure Stack HCI 24H2 rack aware cluster for ALDO (Azure Local Disconnected Operation) using an ARM template.
page_type: sample
products:
- azure
...
This template allows you to create an Azure Stack HCI rack aware cluster for ALDO using version 24H2. First you deploy the template in validate mode which does confirm the parameters at the device. Once passed you re-deploy the template with mode set to deploy.
