...
| DEV | 2 | [coreysa](https://github.com/coreysa) | [Deploy a Docker VM](https://github.com/Azure/azure-quickstart-templates/tree/master/docker-simple-on-ubuntu) | This template allows you to deploy an Ubuntu VM with Docker installed. |
