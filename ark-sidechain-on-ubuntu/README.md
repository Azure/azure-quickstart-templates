...
<p>Once the server is fully deployed, run: curl -o- https://raw.githubusercontent.com/davepinkawa/azure-quickstart-templates/master/ark-sidechain-on-ubuntu/Script/arksidechaindeploy.sh | bash <p>    
