...
resource virtualMachineCreated 'Microsoft.Compute/virtualMachines@2026-03-01' existing = {
  dependsOn: [
    virtualMachine
  ]
  scope: resourceGroup()
...
// resource runcommand_increase_dsc_quota 'Microsoft.Compute/virtualMachines/runCommands@2026-03-01' = if (increaseDscQuota == true) {
...
resource runcommand 'Microsoft.Compute/virtualMachines/runCommands@2026-03-01' = if (runCommandProperties != null) {
  parent: virtualMachineCreated
...
resource extension 'Microsoft.Compute/virtualMachines/extensions@2026-03-01' = if (dscSettings != null) {
  dependsOn: [
