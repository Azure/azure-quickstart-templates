...
param criblVersion string = '4.7.1'
...
resource initcribl 'Microsoft.Compute/virtualMachines/extensions@2022-08-01' = {
  parent: vm
  name: 'initcribl'
  location: location
  properties: {
    ...
    settings: {
      fileUris: [
        uri(_artifactsLocation, 'scripts/deploy_cribl.sh${_artifactsLocationSasToken}')
      ]
      commandToExecute: 'sh deploy_cribl.sh ${criblVersion}'
    }
  }
}
