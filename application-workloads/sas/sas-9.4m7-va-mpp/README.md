...
|Jump VM Size|Specifies the VM size of the jumpvm. Use the default size (recommended).|
...
|Primary User Name| The user name that will be added to the servers to allow SSH access. Username may contain only lower and upper case letters, digits, underscores, or dashes. They can end with a dollar sign. Dashes are not allowed at the beginning of the username. Fully numeric usernames and usernames . or .. are also disallowed. It is not recommended to use usernames beginning with . character as their home directories will be hidden in the ls output. In regular expression terms: [a-zA-Z0-9_.][a-zA-Z0-9_.-]*[$]? Username must be at least 1 character and less than 32 characters long.|
