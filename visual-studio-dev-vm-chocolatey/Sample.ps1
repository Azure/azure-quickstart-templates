...
New-AzureRmResourceGroupDeployment -ResourceGroupName $RGName -TemplateFile $ARMTemplate -storageName $StorageName -deployLocation $DeployLocation -vmName $VMName -vmAdminUserName $VMUsername -vmIPPublicDnsName $VMName -vmVisualStudioVersion VS-2015-Ent-AzureSDK-2.8-WS2012R2 -chocoPackages $ChocoPackages -Mode Complete -Force 
