...
| sshStorageAccountName |  Storage account name for the Private account that will contain your SSH Keys for ansible  ( Only use a Private storage account, as ssh keys should only be accesible by trusted users) |
| sshStorageAccountKey | Storage account Key for the Private account that will contain your SSH Keys for ansible|
