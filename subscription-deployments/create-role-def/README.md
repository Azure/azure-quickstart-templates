---
description: This template is a subscription level template that will create a role definition at subscription scope.
page_type: sample
products:
- azure
...
This template is a subscription level template that will create a new a role definition. The actions include reading resource groups and will be assignable at the subscription scope. You can add/modify/delete as needed. For more information, see [Understand Azure role definitions](https://learn.microsoft.com/azure/role-based-access-control/role-definitions). To learn more about how to deploy the template, see the [quickstart](https://learn.microsoft.com/azure/role-based-access-control/custom-roles-template) article.
...
`Tags: Microsoft.Authorization/roleDefinitions, customRole`
