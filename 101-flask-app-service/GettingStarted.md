...
The intent of this README is to deploy a Flask App. this template was designed to be an easy and fast way to create an App Service to deploy your Flask App.
...
If you haven't your own Flask app yet, you can download a 'Hello World' Flask app example to test it [here](https://github.com/Azure-Samples/python-docs-hello-world).
...
```
az webapp up --name <webapp-name> --debug #That last is to see that all went okay.
```
