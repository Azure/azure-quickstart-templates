...
This template updates RDSH servers in existing session host collection with new update template image. The URI for the image is provided as a template parameter.
