...
function Set-TargetResource
{
    ...
    else 
    {
            ...
            New-StoragePool -FriendlyName 'SqlVMStoragePoll' -StorageSubSystemUniqueId (Get-StorageSubSystem -FriendlyName '*Space*').uniqueID -PhysicalDisks (Get-PhysicalDisk -CanPool $true)
         
            Write-Verbose 'Creating Virtual Disk'
         
            New-VirtualDisk -FriendlyName 'SqlVMDataDisk' -StoragePoolFriendlyName 'SqlVMStoragePoll' -Size $DiskSizeInByte -Interleave $allocationSizeInByte -NumberOfColumns $NumberOfColumns -ProvisioningType Thin -ResiliencySettingName Simple
