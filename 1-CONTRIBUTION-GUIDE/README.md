...
1. The **azuredeploy.json** file must still be included, and must be generated by the bicep compiler (use this command: `bicep build -f main.bicep --outfile azuredeploy.json`)
