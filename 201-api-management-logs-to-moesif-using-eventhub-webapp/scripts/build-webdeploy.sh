...
GITHUB_RUN_BAT_URL="https://raw.githubusercontent.com/Moesif/ApimEventProcessor/master/azure-app-service-webjobs/run.bat"
...
curl ${GITHUB_RUN_BAT_URL} -o .deploy/${WEBJOB_DIR}/run.bat
cd .deploy 
