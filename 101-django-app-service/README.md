...
If you have already a webapp deployed, instead of use the template, use Azure CLI and use the command "az webapp up" like we used on the [GettingStarted](https://github.com/Azure4StudentQSTemplates/azure-quickstart-templates/blob/master/101-django-app-service/GettingStarted.md).
