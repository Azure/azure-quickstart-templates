...
2. Follow steps to [Enable diagnostics logging for the Network Security Group](https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-nsg-manage-log) 
