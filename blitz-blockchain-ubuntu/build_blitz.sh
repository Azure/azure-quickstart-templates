...
#################################################################
sudo apt-get install -y qt4-qmake libqt4-dev libminiupnpc-dev libdb++-dev libdb-dev \
libcrypto++-dev libqrencode-dev libboost-all-dev build-essential libboost-system-dev \
libboost-filesystem-dev libboost-program-options-dev libboost-thread-dev \
build-essential libtool autotools-dev autoconf pkg-config libssl-dev \
libssl-dev libdb++-dev libssl-dev ufw git libevent-dev
