...
# This template deploy a servicebus namespace with standard sku, authorization rule and output will display connectionstrings of default and created authorization rule of namespace.
