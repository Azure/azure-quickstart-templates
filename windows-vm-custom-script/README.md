...
This template allows you to deploy a simple Windows VM and execute a custom script using the custom script extension.
...
| scriptFile  | The script file that will be downloaded and executed  |
