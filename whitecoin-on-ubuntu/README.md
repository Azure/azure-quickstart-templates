...
This Microsoft Azure template deploys a single Whitecoin client which will connect to the public Whitecoin network.
...
* `adminUsername`: This is the account for connecting to your Whitecoin host.
