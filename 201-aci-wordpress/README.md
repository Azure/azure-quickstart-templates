...
This template creates a WordPress website and its MySQL database on Container Instance. The WordPress site contents and MySQL database are persistently stored on Azure Storage File Share.
