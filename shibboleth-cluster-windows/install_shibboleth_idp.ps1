...
cmd.exe /c "netsh advfirewall firewall add rule name="Allow TCP 22,80,8080,8443" dir=in action=allow edge=yes remoteip=any protocol=TCP localport=80,8080,8443"
...
$destination = "C:\apache-tomcat-7.0.67\lib\mysql-connector-java-5.1.6.jar"
$client = new-object System.Net.WebClient 
$cookie = "oraclelicense=accept-securebackup-cookie"
$client.Headers.Add([System.Net.HttpRequestHeader]::Cookie, $cookie) 
$client.DownloadFile($source,$destination)
