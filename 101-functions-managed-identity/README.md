# Provision a function app on a consumption plan on Windows with managed identity created and assigned
...
This template creates a function application on a consumption plan on Windows. It also enables managed identity for the application.
