...
This template creates a WordPress website and its MySQL database on container Instances in a virtual network. The WordPress site content and MySQL database are persistently stored on an Azure Storage File Share.
...
+ **Application gateway**: Application gateway for WordPress site.
