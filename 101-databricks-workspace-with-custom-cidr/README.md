# Deploy an Azure Databricks Workspace with a Custom VNet Address Range
...
This template allows you to create a Azure Databricks workspace with a custom VNet address range.
