# Create a virtual machine from a specialized vhd in an existing virtual network
...
This template creates a VM from a specialized VHD and lets you connect it to an existing VNET that can reside in another Resource Group then the virtual machine.
