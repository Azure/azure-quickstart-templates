# 101-servicebus-topic-subscription-sqlfilter
 This template allows you to deploy Service Bus Namespace and Topic with a Subscription using a SQL Filter expression to receive only the messages that match the defined SQL Filter Expression.
