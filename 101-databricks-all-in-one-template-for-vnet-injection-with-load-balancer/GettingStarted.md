...
The purpose of this ARM Template is **Deploy a Load Balancer, Network Security Group, a Virtual Network and an Azure Databricks Workspace with the Virtual Network** inserting a few parameters.
