...
A Recovery Services vault can only change storage options before any backups have been stored. Once any backup is configured, storage type cannot be changed. Hence use conditional parameter to opt-in or opt-out change storage type [Learn more] (https://docs.microsoft.com/en-us/azure/backup/backup-azure-backup-faq#can-i-change-from-grs-to-lrs-after-a-backup)