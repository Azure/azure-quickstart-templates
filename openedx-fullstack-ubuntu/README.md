# Deploy Open edX Dogwood (FullStack) on Ubuntu
...
This template deploys Open edX Dogwood (FullStack) on Ubuntu. A default server-vars.yml is saved to */edx/app/edx_ansible*.
