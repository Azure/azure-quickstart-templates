...
During the public preview deployment might take up to 48h. The reason why provision takes some time is that along the Managed Instance virtual cluster that hosts the instance is created. Each subsequent instance creation takes just about a few minutes.
